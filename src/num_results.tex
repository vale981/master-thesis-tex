...
various cutoff frequencies of the BCF in \cref{sec:one_bath_cutoff,}, we now consider the case with fixed cutoff \(ω_c=2\)
but varying coupling strength. The results presented here are mainly a
