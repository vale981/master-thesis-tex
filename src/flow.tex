...
\label{chap:flow}
\begin{itemize}
\item remind of the main goal
\item motivate why this is expected to be achievable with NMQSD/HOPS
\item outline the different parts of the derivation: from special case
  to most general
\end{itemize}
